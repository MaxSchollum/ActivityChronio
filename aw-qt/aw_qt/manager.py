...
# Ensure user bin is discoverable for aw-* modules when launched from GUI/launchd
aw_qt_extra_paths = [str(Path.home() / "bin")]
...
def _discover_modules_system() -> List["Module"]:
    ...
    # Add ~/bin explicitly for GUI/launchd environments
    for p in aw_qt_extra_paths:
